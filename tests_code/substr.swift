...
var s1 : String? = 
  " Toto je nejaky text "  // ukoncujici uvozovky ovlivnuji implicitni odsazeni vnitrnich radku retezce
...
s1String = s3 ?? " viceradkovy retezec misto nil vysledku " // vysledny retezec v s1 bude mit 4 znaky
